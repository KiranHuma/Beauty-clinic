...
Public Class inventryfrm
    ...
    Private Sub txtboxid()
        Try
            ...
            con.Close()
        Catch ex As Exception
            MsgBox("Error in Autoincrement of Inventory Entry" & ex.Message)
            Me.Dispose()
        End Try
    End Sub
    'Delete function
    Private Sub DeleteSelecedRows()
        Try
            ...
            Next
        Catch ex As Exception
            MessageBox.Show("Error in Deleting Selected Values" & ex.Message)
            Me.Dispose()
        End Try
    ...
    Private Sub autogenerated()
        Try
            ...
            End Using
        Catch ex As Exception
            MessageBox.Show("Error in AutoIncrement of Inventory ID" & ex.Message)
            Me.Dispose()
        End Try
    End Sub
    'Show data in inventory data tab's grid,getting data from two tables by join
    Private Sub getdata()
        ...
        Catch ex As Exception
            MessageBox.Show(" Error while Retriving the Data of Products And Inventory" & ex.Message)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub in_getdata()
        Try
            ...
            get_indata.Refresh()
        Catch ex As Exception
            MessageBox.Show(" Error while Retriving the Data of Inventory" & ex.Message)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub FillCombo()
        ...
        Catch ex As Exception
            MessageBox.Show(" Error while Retriving and Papulating Product ID " & ex.Message)
            Me.Dispose()
        End Try
    ...
    Private Sub clear()
        ...
        Catch ex As Exception
            MsgBox("Error:Add New" & ex.Message)
            Me.Dispose()
        End Try
    End Sub
    '>>>>>>>>>>>>>>>>>>>>>Buttons<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    Private Sub pid_txt_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pid_txt.SelectedIndexChanged
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show("Error:ProductID from Products Failed", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Me.Dispose()
        End Try
    ...
    Private Sub get_indata_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles get_indata.CellMouseClick
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:TextBox not found ", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub stockin()
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:Adding Quantity Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub inname_txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles inname_txt.TextChanged
        Try
            ...
            Next
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:Product Name Papulating Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub RadioButton4_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton4.CheckedChanged
        Try
            ...
            get_indata.Refresh()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:StockIn Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub RadioButton3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton3.CheckedChanged
        Try
            ...
            get_indata.Refresh()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:StockOut Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub search_txt()
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:Product Name Search Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub payment_productsearchdate()
        ...
        Try
            ...
            get_indata.Refresh()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:Date Search Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub inquatity_txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles inquatity_txt.TextChanged
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error:Stock Status Failed", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Me.Dispose()
        End Try
    End Sub
    ...
    Private Sub intxt_des_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub inventrydtetxt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub inprice_txt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
