...
Public Class ratesfrm
    ...
    Private Sub p_insert()
        dbaccessconnection()
        con.Open()
        cmd.CommandText = "insert into tbl_productsales(transactionid,mname,mbid,pname,pid,pquantity,pprice,sle,unitprce,sname,ssale,sprice,emname,discount,tbill,pdte)values('" & transactionid_txt.Text & "','" & mname_txt.Text & "','" & mbid_txt.Text & "','" & pname_txt.Text & "','" & pid_txt.Text & "','" & pprice_txt.Text & "','" & pquantity_txt.Text & "','" & pprice_txt.Text & "','" & pquantity_txt.Text & "','" & psale_txt.Text & "','" & unitprce_txt.Text & "','" & sname_txt.Text & "','" & sprice_txt.Text & "','" & ssale_txt.Text & "','" & emname_txt.Text & "','" & discount_txt.Text & "','" & tbill_txt.Text & "','" & p_date_txt.Value & "')"
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    ...
    Private Sub p_getdata()
        ...
        Dim con As New SqlConnection(cs)
        con.Open()
        Dim da As New SqlDataAdapter("Select transactionid,mname,mbid,pname,pid,pquantity,pprice,sle,unitprce,sname,ssale,sprice,emname,discount,tbill,pdte from tbl_productsales ", con)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Private Sub p_discount()
        ...
        PercentageNumberResult = TextBox4.Text / 100 * discount_txt.Text
        TextBox5.Text = PercentageNumberResult
        Dim subtractdiscount As Double
        subtractdiscount = TextBox4.Text - TextBox5.Text
        TextBox7.Text = subtractdiscount
    End Sub
    ...
    Private Sub s_pricetotal()
        ...
        addd = Convert.ToInt64(sprice_txt.Text) + Convert.ToInt64(Label39.Text)
        Label39.Text = Convert.ToString(addd)
    ...
    Private Sub totalbill()
        ...
        addd = Convert.ToInt64(uinttotalprice_txt.Text) + Convert.ToInt64(Label39.Text)
        TextBox4.Text = Convert.ToString(addd)
