...
Public Class prodcutfrm
    ...
    Private Sub insert()
        dbaccessconnection()
        con.Open()
        cmd.CommandText = "insert into tbl_products(p_id,p_name,p_price,p_description,p_typ,p_dte,photo)values('" & pid_txt.Text & "','" & name_txt.Text & "','" & price_txt.Text & "','" & des_txt.Text & "','" & salpr_txt.Text & "','" & p_dtetxt.Value & "',@photo)"
    ...
    Private Sub autogenerated()
        ...
        mysqlconnection.ConnectionString = " Data Source=ADMINRG-FFQIQKT;Initial Catalog=mainclinicdb;Integrated Security=True "
        command.Connection = mysqlconnection
        mysqlconnection.Open()

        Dim sqlquery = "select Max(p_id) from tbl_products "
    ...
    Private Sub getdata()
        ...
        con.Open()
        Dim da As New SqlDataAdapter("Select p_id,p_name,p_price,p_description,p_typ,p_dte,photo from tbl_products ", con)
        Dim dt As New DataTable
        da.Fill(dt)
