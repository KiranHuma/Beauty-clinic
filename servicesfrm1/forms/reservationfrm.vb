...
Public Class reservationfrm
    ...
    Private Sub RateID_FillCombo()
        ...
        Catch ex As Exception
            MessageBox.Show("Failed:Retrieving and Populating Recent RatesID " & ex.Message)
            Me.Dispose()
        End Try
    ...
    Private Sub M_ID_FillCombo()
        ...
        Catch ex As Exception
            MessageBox.Show("Failed:Retrieving Registered MembersID " & ex.Message)
            Me.Dispose()
        End Try
    ...
    Private Sub getdata_reservation()
        ...
        Catch ex As Exception
            MessageBox.Show("Failed:Today Reservation", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Me.Dispose()
        End Try
    End Sub
