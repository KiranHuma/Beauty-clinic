...
Public Class productreporfrm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cn.Open()
        Dim str As String = "select p_id,p_name,p_price,p_description,p_typ,p_dte  from tbl_products  where p_dte >= '" & Format(dfrom, "MM-dd-yyyy") & "' and p_dte <='" & Format(dto, "MM-dd-yyyy") & "'"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            MyCommand.CommandText = "select p_id,p_name,p_price,p_description,p_typ,p_dte  from tbl_products  where p_dte  >= '" & Format(dfrom, "MM-dd-yyyy") & "' and p_dte <='" & Format(dto, "MM-dd-yyyy") & "'"
