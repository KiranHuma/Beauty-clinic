...
Public Class ServicesSaleExport
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Dim strExportFile As String = "e:\ServicesSaleReport.doc"
        ...
        objOptions = Nothing
        reportWord = Nothing
        MsgBox("Please Check your E Drive.There will be a File with the Name of ServiceSaleReport.Please Copy and Paste it in other folder for record otherwise it will replace when you print new one")
    End Sub
